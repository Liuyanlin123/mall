...
import org.mochou.mymall.db.service.MymallOrderGoodsService;
...
public class OrderJob {
    ...
    public void checkOrderUnpaid() {
        ...
        List<MymallOrder> orderList = orderService.queryUnpaid();
    ...
    public void checkOrderUnconfirm() {
        ...
        List<MymallOrder> orderList = orderService.queryUnconfirm();
        for (MymallOrder order : orderList) {
    ...
    public void checkOrderComment() {
        ...
        LocalDateTime now = LocalDateTime.now();
        List<MymallOrder> orderList = orderService.queryComment();
        for (MymallOrder order : orderList) {
